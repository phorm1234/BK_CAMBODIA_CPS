			...
			if(count($row_docno)>0){
				...
				foreach($row_docno as $data){
					...
					echo "<p align='center'>
								...
								<tr height='35'>
									<td colspan='5' align='center'><img src='/sales/img/op/cps-logo.gif' style='height: 50px;width: 220px;margin-bottom: -10px;'></td>
								</tr>
								<tr height='35'>
...
// 						    </tr>";
		...
		//ข้อความท้ายบิล beauty first class
			...
			//*WR21022018 fix temp for test
			
			if($_SERVER['REMOTE_ADDR']=="192.168.3.166"){
			    $row_h[0]['print2ip']="10.10.35.57";
			}
			...
			if(count($row_docno)>0){
				...
				if($billHead[0]['flag']=='C'){
					...
					echo "<p align='center'>
								<table width='100%' border='0' cellpadding='2' cellspacing='0' bgcolor='#ffffff'>								
								<tr height='35'>
									<td colspan='6' align='center'><img src='/sales/img/op/cps-logo.gif' style='height: 50px;width: 220px;margin-bottom: -10px;'></td>
								</tr>
								<tr height='35'>
				...
				foreach($row_docno as $data){
			        ...
			        foreach($billDetail as $dataL){
							...
							echo "<tr>
										...
										<td>".$dataL['product_id']."</td>
										<td>$name_product</td>
										<td width='6%' align='right'>$sumdisc</td>
										<td width='10%' align='right'>".number_format($dataL['price'],2)."</td>
										<td width='10%' align='right'>".$item_net_amt."</td>
									</tr>";
						...
						if($doc_tp=='SL'){
							...
							echo "
								...
								<tr>
									...
									<td >&nbsp;</td>
									<td align='right'>".number_format(abs($billHead[0]['change2']),2)."</td>
								</tr>

								<tr>
									<td align='center'>&nbsp;</td>
									<td  colspan='2'>*Total Included VAT</td>
								</tr>
								";
					  echo "</table>";
					  echo "<table width='100%' border='0' cellpadding='2' cellspacing='0' bgcolor='#ffffff'>";
