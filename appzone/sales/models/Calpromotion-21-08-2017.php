...
class Model_Calpromotion extends Model_PosGlobal
{
		...
		public $sv_api="crmll.ssup.co.th";
		public $sv_online="10.100.59.151";
		public $user_online="crm-ll";
		public $pass_online="n2jKYY3X73aTMtKX3nacXq8LyQ4QRXJa";
		public $db_online="service_pos_lalil";
		public $db_online_old="pos_ll";		
...
doc_date between 
		...
		function read_point($member_no){
			...
			$fp =fopen("http://$this->sv_api/app_service_lalil/process/member_point_all.php?member_no=$member_no", "r");
            $text=fgetss($fp, 4096);
            return $text;
		}
...
/*
		...
		function transfer_point($doc_no){
			...
			if($rows_find>0){
					if( ($status_no=="01") && ($application_id!="OPPN300")  && (substr($application_id,0,3)!="OPN") && ($application_id!="") &&  ($member_id!="") ){//ต่ออายุ  member
		...
		function member_bypeple($member_no){
            ...
            $fp = @fopen("http://$this->sv_api/app_service_lalil/process/member_bypeple.php?member_no=$member_no", "r");
            $text=@fgetss($fp, 4096);
            return  $text;
		...
		function promo_chk_hbd($member_no){
			/*
				$fp = @fopen("http://$this->sv_api/app_service_lalil/api_member/api_pro_birthday.php?id_card=$member_no&doc_date=".$this->doc_date, "r");
		...
		function sale_all($member_no){
            $fp = @fopen("http://$this->sv_api/app_service_lalil/process/member_sale_all.php?member_no=$member_no", "r");
            $text=@fgetss($fp, 4096);
            return  $text;
		}
