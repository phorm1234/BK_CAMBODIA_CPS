<?php
		...
		mysql_db_query($dbname,"delete from promo_branch where  promo_code='$promo_code'  ",$conn_shop);


		$sql_branch="select * from promo_branch_tmp   where promo_code='$promo_code'   order by promo_code";
		$r_branch=mysql_db_query($dbname,$sql_branch,$conn_shop);
