...
function chk_snap(){
	...
	if(document.getElementById("nation").checked==1){
...
?>
  ...
  <input name="promo_code" type="hidden" id="nation" value="1"  />
</div>
    ...
    <tr>
      <td><table border="0" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
          ...
          <td><input name="radio_nation" type="radio" value="radiobutton" checked="checked" onclick="document.getElementById('nation').value=1;$('#showfromotpcode').show();" />
            <span class="style2">ไทย</span>&nbsp;&nbsp;&nbsp;
            <input name="radio_nation" type="radio" value="radiobutton"  onclick="document.getElementById('nation').value=2; $('#showfromotpcode').hide();"/>
        ...
        <tr>
          ...
          <td><input name="birthday" type="text" id="birthday"  style="width:200px; height:50px;font-size:24px;color:#0066FF;" />
            <span class="style16">รูปแบบ 1996-04-09 </span></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
		  ...
		  <legend >Confirm OTP CODE</legend>
            <table border="0">
              <tr>
                <td><span class="style2">กดปุ่มส่ง OTP CODE เข้ามือถือสมาชิก 
                  
                </span></td>
                <td><input name="Button" type="button" class="style1" value=" ส่ง OTP CODE " onclick="apisendotpx('<?php echo $_GET[mobile_no];?>');" /></td>
              </tr>
              <tr>
