...
<table border="0">
  ...
  <tr>
    ...
    <td rowspan="2" valign="top"><div align="center" id='show_pic'  ></div></td>
    <td valign="top">&nbsp;</td>
    <td valign="top"><div align="center"><img src='../../../download_promotion/id_card/camera.jpeg' width='50px' hiegth='50px' onClick="fromsnap();" style="cursor:pointer;"></div></td>
  </tr>
  <tr>
    <td valign="top" class='label1'><table border="0">
      <tr>
  ...
  <tr>
    <td colspan="4" valign="top" class='label1'><br><br><br><br> <div align="center" style="font-size: 22px;color: #FF0000;">** กรณีที่ไม่สามารถอ่านบัตรประชาชนลูกค้าจากเครื่องอ่านบัตรได้ ให้ถ่ายรูปบัตรประชาชนลูกค้าเอาไว้นะคะ ถึงจะสมัครสมาชิกได้ </div></td>
  </tr>
</table>
