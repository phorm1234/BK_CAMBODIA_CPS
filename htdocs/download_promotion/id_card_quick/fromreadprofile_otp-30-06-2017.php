...
<body>
<div id='popup_snapx'  style="display:none;"  title="ถ่ายรูป" ></div>
<div align="left">
  <?php
  ...
  <table border="0" align="center">
    ...
    <tr>
      <td><table border="0" align="center" cellpadding="3" cellspacing="3">
        ...
        <tr>
          <td colspan="3" class="style1"><div id="show_country" class="style1">เลือกประเทศ
            <?php
        ...
        <tr>
          <td class="style1"><div id='label_id'>เลขที่บัตรประชาชน</div></td>
        ...
        <tr>
          ...
          <td><div id='show_btn_send_otp'><input name="Button" type="button" style="color:17a009; font-size:20px;" value=" ส่ง OTP CODE " onclick="fromreadprofile_sendotp();"/></div></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td class="style1">&nbsp;</td>
