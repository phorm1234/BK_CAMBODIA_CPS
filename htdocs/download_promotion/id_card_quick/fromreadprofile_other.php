...
.style3 {color: #FF0000; font-size:28px;}
.style4 {color: #0066FF; font-size:22px;}
...
function onreadidcheck(){
	...
	document.getElementById('show_label_valotp').style.visibility='hidden';
	document.getElementById('show_input_valotp').style.visibility='hidden';
    ...
    <tr>
      <td height="100" colspan="3"><div align="center" >
        <table border="0" cellpadding="3" cellspacing="3">
            <tr>
              <td><img src="../../../download_promotion/id_card_quick/clubcard.jpg" width="97" height="57" /></td>
      ...
      <center><div id='promo_des' style="font-size:28px; color:#99CC00;"></div><hr style="color:#17a009"></center></td>
    </tr>
    <tr>
      <td><table border="0" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
          <td class="style4"><span class="style3">1. </span>ใส่รหัสบัตรประชาชน <img src="../../../download_promotion/id_card_quick/id_card.jpeg" width="66" height="39" /> ที่ช่องนี้</td>
          <td><input name="id_card" type="text" id="id_card"   onkeydown="if (event.keyCode == 13){document.getElementById('id1').focus();}" style="width:250px; height:50px; font-size:24px;color:#0066FF;" /></td>
          <td><input name="nothai" type="hidden" id="nothai" value="checkbox" />
            <input name="fname" type="hidden" id="fname"  onkeydown="if (event.keyCode == 13){document.getElementById('lname').focus();}"/>
            <input name="lname" type="hidden" id="lname"  onkeydown="if (event.keyCode == 13){document.getElementById('mobile_no').focus();}"/>
            <input name="member_no" type="hidden" id="member_no" /></td>
          <td>&nbsp;</td>
        </tr>

        <tr>
          <td class="style4"><span class="style3">2.</span> ใส่รหัสบัตร <span id='show_label_coupon'>Club Card  <img src="../../../download_promotion/id_card_quick/clubcard.jpg" width="66" height="39"  /> ที่ช่องนี้</span></td>
          <td><div id='show_text_coupon'>
            <input name="id1" type="text" id="id1" onclick="$('#id1').val('');" onkeyup="keynext('id1','id2','7')" size="2" maxlength="7";  style="height:50px;font-size:24px;color:#0066FF;"/>
            <input name="id2" type="text" id="id2" onkeyup="keynext('id2','id3','4')" size="1" maxlength="4" style="height:50px;font-size:24px;color:#0066FF;"/>
            <input name="id3" type="text" id="id3" onkeyup="keynext('id3','id4','4')" size="1" maxlength="4"   style="height:50px;font-size:24px;color:#0066FF;"/>
            <input name="id4" type="text" id="id4"  size="1" maxlength="3"   style="height:50px;font-size:24px;color:#0066FF;" onkeydown="if (event.keyCode == 13){document.getElementById('mobile_no').focus();}"/>
          </div></td>
          <td><input name="chk_ecoupon" type="hidden" id="chk_ecoupon" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td class="style4"><span id='show_label_mobile'><span class="style3">3.</span> ใส่<span id='show_label_mobile'>เบอร์มือถือของลูกค้า  ที่<img src="../../../download_promotion/id_card_quick/mobile.gif" width="30" height="39"  />ช่องนี้</span></span></td>
          <td><div id='show_input_mobile'><input name="mobile_no" type="text" id="mobile_no" style="width:250px; height:50px; font-size:24px;color:#0066FF;" onkeydown="if (event.keyCode == 13){if(document.getElementById('status_readcard').value=='MANUAL'){fromreadprofile_sendotp_other();}else{fromreadprofile_other_save();}}" /></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td class="style4"><span id='show_label_otp'><span class="style3">4.</span> กดปุ่มนี้เพื่อส่ง OTP CODE เข้ามือถือลูกค้า</span></td>
          <td class="style1"><span id='show_btn_send_otp'>
            <input name="Button" type="button" style="color:17a009; font-size:20px; width:250px;" value=" ส่ง OTP CODE " onclick="fromreadprofile_sendotp_other();"/>
          </span></td>
          <td class="style4">&nbsp;</td>
          <td class="style1">&nbsp;</td>
        </tr>
        <tr>
          <td class="style4"><span id='show_label_valotp'><span class="style3">5.</span> ใส่ OTP CODE ที่ได้จากมือถือของลูกค้าที่ช่องนี้ </span></td>
          <td><div id='show_input_valotp'><input name="val_otp" type="text" id="val_otp" style="width:250px; height:50px; font-size:26px;color:#f07938; border-color:#99CC00; background-color:#caf4c6" onkeydown="if (event.keyCode == 13){fromreadprofile_other_save();}"/></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
      ...
      <td valign="top" style="border-left:1px; dashed #000;"><table width="200" border="0" align="center">
        <tr>
