    ...
    <tr>
      <td><table border="0" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
          ...
          <td><input name="id_card" type="text" id="id_card"  style="width:200px; height:50px;font-size:24px;color:#0066FF;" onkeydown="if (event.keyCode == 13){document.getElementById('otp_code').focus();}"/></td>
          <td><input name="member_no" type="hidden" id="member_no"  value="<?php echo $_GET[member_no]; ?>"/>
          <input name="nothai" type="hidden" id="nothai" value="checkbox" />
            ...
            <input name="mobile_no" type="hidden" id="mobile_no" style="width:200px; height:50px; font-size:24px;color:#0066FF; border-color:#efd890; background-color:#f2dfa6;"/></td>
          <td>&nbsp;</td>
        </tr>

        <tr>
          <td class="style1"><span style="color:17a009; font-size:28px;">E-coupon :</span></td>
          <td><input name="otp_code" type="text" id="otp_code" style="width:200px; height:50px; font-size:26px;color:#f07938; border-color:#99CC00; background-color:#caf4c6" onkeydown="if (event.keyCode == 13){fromreadprofile_save();}"/></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
	  ...
	  <?php if($_GET['promo_code']!="OPPLI300"){?>
