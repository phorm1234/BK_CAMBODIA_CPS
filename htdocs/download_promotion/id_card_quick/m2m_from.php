...
function find_profile_old(member_no) {
	...
	$.get(pathajax,{
					...
					ran:Math.random()},function(data){
						...
						document.getElementById("hbd_day").value =parseInt(hbd_day);
						document.getElementById("hbd_month").value =parseInt(hbd_month);
						document.getElementById("hbd_year").value =parseInt(hbd_year);
  ...
  <table border="0" align="center">
    ...
    <tr>
      <td><table border="0" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
          <td class="style1">รหัสบัตรประชาชน
            <input name="chk_id_card" type="hidden" id="chk_id_card"  /></td>
          <td><input name="id_card" type="text" id="id_card"  style="width:200px; height:50px;font-size:24px;color:#0066FF;" onKeyDown="if (event.keyCode == 13){document.getElementById('mobile_no').focus();}"  readonly="true"/></td>
        ...
        <tr>
          <td class="style1"><div id='show_label_mobile'></div></td>
          <td><div id='show_btn_send_otp'>
            <input name="Button" type="button" style="color:17a009; font-size:20px;" value=" ส่ง OTP CODE " onclick="m2m_sendotp();"/>
          </div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td class="style1"><div id='show_input_mobile'>
            <input name="mobile_no" type="hidden" id="mobile_no" style="width:200px; height:50px; font-size:24px;color:#0066FF;" onkeydown="if (event.keyCode == 13){fromreadprofile_sendotp();}" />
          </div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td class="style1"><div id='show_label_otp'><span style="color:17a009; font-size:28px;">ใส่ OTP CODE  :</span></div></td>
