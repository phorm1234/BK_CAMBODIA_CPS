...
//no coupon code
$arr_nocoupon=array('LLSV101801','BD001');
...
}elseif($promo_code=="LLFP201801"||$promo_code=="181001"){
	echo "Y###Complete";
	return false;
}
...
if($promo_code!="OM13160416" && $promo_code!="OM13061216" && $promo_code!="BD001"){
	if($id_card!=""){
		...
		if($rows_find_local>0){
			...
			echo "stop###aรหัสบัตร ปชช. นี้ ใช้แล้วที่สาขา $data_local[branch_id] ด้วยบิลเลขที่ $data_local[doc_no] เมื่อวันที่ $data_local[doc_date]";
			return false;
		}
	}
