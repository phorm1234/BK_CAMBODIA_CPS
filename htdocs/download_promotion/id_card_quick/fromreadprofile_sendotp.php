...
if($promo_code=="OX02460217" || $promo_code=="OX02460217_2" || $promo_code=="OX02250117" ){
	$path_api="http://mshop.ssup.co.th/shop_op/opkh_promotion.php?idcard=$id_card&shop=$shop&memberid=xxx&mobile=$mobile_no&promortion=$promo_code";	
...
}else if($promo_code=="OPTRUE300" || $promo_code=="OPNDTAC"){ //pro OPTRUE300 ให้เช็คการใช้ซ้ำ
