...
function onreadidcheck(){
	...
	/*if(document.getElementById('promo_code').value!="OPLID300" && document.getElementById('promo_code').value!="OI07200216"){
    ...
    <tr>
      <td height="100" colspan="3"><div align="center" >
        <table border="0" cellpadding="3" cellspacing="3">
            <tr>
              <td>&nbsp;</td>
              <td><span style="font-size:28px; color:#99CC00;">รหัสโปรโมชั่น : </span>
                <input name="promo_code" type="text" id="promo_code"  style="color:#0066FF; font-size:28px; background-color:#FFFFFF; border:0px; width:180px"/></td>
              <td><span style="font-size:28px; color:#99CC00;">ชื่อโปร : </span></td>
              <td><div id='promo_des' style="font-size:28px; color:#0066FF;"></div></td>
            </tr>
          </table>
      </div><center><hr style="color:#17a009"></center></td>
    </tr>
    <tr>
      <td><table border="0" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
          <td class="style1">สัญชาติ</td>
          <td><input name="mynation" type="radio" value="1" checked="checked" id="nation1" />
            <span class="style5">ไทย</span>
            <input name="mynation" type="radio" value="2" id="nation2"/>
            <span class="style5">ต่างชาติ</span></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td class="style1">รหัสบัตรประชาชน
            <input name="id_card_chk" type="hidden" id="id_card_chk" /></td>
        ...
        <tr>
          <td class="style1"><div id='show_label_mobile'><span >เบอร์มือถือ :</span></div></td>
          ...
          <td><div id='show_btn_send_otp'><input name="Button" type="button" style="color:17a009; font-size:20px;" value=" ส่ง OTP CODE " onclick="fromreadprofile_verify_sendotp();"/></div></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td class="style1">&nbsp;</td>
