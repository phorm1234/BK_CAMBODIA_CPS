...
if($rows!='0'){
				...
				for($i=1; $i<=$rows; $i++){
					...
					if($result_insert){
						...
						echo "<font color='green'>Bill : $doc_no at $doc_date <hr>Insert Complete<br> </font>";
						
					}else{
						echo "<font color='red'>Bill : $doc_no at $doc_date <hr>Insert Duplicate<br> </font>";
					}
				...
				echo "<center><h2>Can't send bill no : $doc_no</h2></center><br>";
}
...
<a href="toserver_frombill_renew.php" class='style2'>Back</a>
</center>