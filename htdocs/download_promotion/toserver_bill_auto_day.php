...
$conf="select *  from trn_diary1 where doc_date=date(now())-interval 1 day ";	
...
FROM `trn_diary1_auto_tmp` as a left join (select * from trn_diary1 where doc_date=date(now())-interval 1 day and branch_id='$branch_id') as b
on a.doc_no=b.doc_no
where
a.doc_date=date(now())-interval 1 day and
b.doc_no is null
";
