...
<APPLET CODE = 'idcard.RdNationalCardID' archive='../../download_promotion/id_card_newmem/lib/RdNIDApplet090DL.jar' name='NIDApplet' WIDTH = "0" HEIGHT = "0">
</APPLET>  
...
function onreadidcheck(){
	...
	search_idcard($('#id_card').val(),'AUTO');
...
function show_idcard(){
	document.getElementById("from_label").style.display = "";
	document.getElementById("from_cap").style.display = "";
	document.getElementById("from_ok").style.display = "";
	document.getElementById("id_card").style.border = "";
	$("#id_card").focus();

}
function show_fromotp(){
	...
	document.getElementById("from_label_otp").style.display = "";
	document.getElementById("from_val_otp").style.display = "";
	document.getElementById("from_ok_otp").style.display = "";
	$("#val_otp").focus();
...
<table border="0" align="center" cellpadding="3" cellspacing="3" bordercolor="#0099FF">
  <tr>
    ...
    <td class="textmanual">เสียบบัตร ปชช. ของสมาชิกที่เครื่องอ่าน ID CARD<img src="../../download_promotion/id_card_newmem/icon_idcard.png" width="30" height="30"></td>
  ...
  <tr>
    ...
    <td colspan="2"><table border="0" cellpadding="3" cellspacing="3">
      <tr>
        ...
        <td width="100"><div  onclick="ccsreadidcardfrom_mode_photo();" class="round-button-circle" align="center" style="background-color:#f79646;border:5px solid #f9d2b2;"><a  class="round-button" style="color:#355e90; vertical-align:middle;" ><img src="../../../download_promotion/id_card_newmem/icon_camera.gif" width="40px" height="40px" /><br />
