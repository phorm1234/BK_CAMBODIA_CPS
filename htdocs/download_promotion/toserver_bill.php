...
$clear="delete from trn_diary1_tmp where branch_id='$shop' ";
...
$conf="select *  from  trn_diary1 where  doc_date between  '$start_date' and '$end_date'";	
echo $conf;	
...
FROM `trn_diary1_tmp` as a left join trn_diary1 as b
