...
$conf="select *  from trn_diary1 where  doc_date ='$doc_date'  order by doc_time desc";	
echo $conf;	
$conn_shop=mysql_connect($ipserver,$mysql_user,$mysql_pass) or die("no connect mysql");
mysql_query("SET character_set_results=utf8");
mysql_query("SET character_set_client=utf8");
...
echo "<br>Download Diary2<br>";
$path_run="http://localhost/download_promotion/toserver_bill_diary2_byday.php?doc_date=$doc_date&branch_id=$shop";
echo "<br>$path_run<br>";
