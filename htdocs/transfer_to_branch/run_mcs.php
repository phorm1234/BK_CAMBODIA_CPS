<?php
	...
	system("chmod 777  -R /var/www/mcs");
	system("rm -rf /var/www/pos/htdocs/transfer_to_branch/mcs.zip");
	system("wget http://10.100.53.2/ims/transfer_to_branch/mcs.zip && echo 'Success' || echo 'Fail' ");
	system("rm -rf /var/www/mcs.zip");
	system("unzip -o mcs.zip -d /var/www/");
	system("chmod 777  -R /var/www/mcs");
?>
