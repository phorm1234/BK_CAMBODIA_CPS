...
function closeWinIframe(){
	...
	function formConfirmOpen(){
		...
		var dialogOpts_OpenCashDrawer= {
				...
				title:"ยืนยันการเปิด CashDrawer",
				closeOnEscape:true,
				open: function(){ 
				...
				close: function() {
				 ...
				 buttons: {
							"ยืนยัน":function(evt){ 	
					 				...
					 				if(m_cashdrawer!='Y'){
					 					jAlert('ไม่พบ CashDrawer กรุณาตรวจสอบอีกครั้ง','ผลการบันทึกการเปิด CashDrawer',function(){
					    					return false;
							    		 });
					 					return false;
					 				}
					 				...
					 				if(cshdrw_employee_id.length==0){
					 					jAlert('กรุณาระบุรหัสพนักงาน','ข้อความแจ้งเตือน',function(){
					 				...
					 				if(remark_id=='0'){
					 					jAlert('กรุณาระบุเหตุผล','ข้อความแจ้งเตือน',function(){
					 						$("#remark_id").focus();
					    					return false;
							    		 });
					 					return false;
...
//												}else
												if(obj_json.check_status=='P'){//$.trim(arr_data[3])
													...
													jConfirm('คุณต้องการเปิด CashDrawer ใช่หรือไม่?','ยืนยัน',function(r) {
													    if(r){ 
													    	...
													    	var opts_cashdr={
													    			...
													    			data:{
													    				...
													    				if(data=='Y'){
													    					...
													    					jAlert('เกิดปัญหาไม่สามารถบันทึกการเปิดได้','ผลการบันทึกการเปิด CashDrawer',function(){
																				$("#dlg_opencashdrawer").dialog("close");
														    					return false;
																    		 });
													    					return false;
