$(function(){	
	...
	function callBackCardLost(data){
		...
		//alert("result => " + str_search_result + "\ncallback => " + data);
		//alert(arr_search_result[0]+"=="+arr_callbackdata[0]);
	...
	function paymentBillOrg(status_no){
		...
		*/		
		...
		if(status_couponpromo=='Y'){
			coupon_code=$('#csh_promo_code').val();//coupon promo_code
		}
		var cn_amount=$("#cn_amount").val();
	            					...
	            					if(data=='Y'){
	            	            		...
	            	            		//satart old
	            	            		 if(csh_status_no=='01'){
		            	     			    	...
		            	     			    	//redeemPoint();		            	     			    	
		            	     			    	if(getOnlineStatus()===1){
		            	     			    		setTimeout(function(){fromreadidcard('',member_no,csh_status_no);},1000);  
		            	     			    	}else{
		            	     			    		//callMemberOffline();
