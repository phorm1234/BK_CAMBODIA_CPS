...
//								    }else 
	...
	function mstPromotion(promo_code,seq_pro,s_play,title){
		...
		if(promo_code=="OK06010318"){
			if(seq_pro=='1'){
				seq_msg_show="สแกน Perfect Matte UV Protection For Face SPF50(26605) 1 ชิ้น";
			}else if(seq_pro=='2'){
				seq_msg_show="สแกน All Day Sun Powder(25810,25811,25824) 1 ชิ้น";
			}
		...
		if(promo_code=="OK02500118"){
			if(seq_pro=='1'){
				seq_msg_show="สแกน Velvet Eye Colours(26648-26677) 1 ชิ้น";
			}else if(seq_pro=='2'){
				seq_msg_show="สแกน Velvet Cheek Colours(26678-26692) 1 ชิ้น";
			}else if(seq_pro=='3'){
				seq_msg_show="สแกน Velvet Eye Colours(26648-26677) 1 ชิ้น";
			}else if(seq_pro=='4'){
				seq_msg_show="สแกน Velvet Cheek Colours(26678-26692) 1 ชิ้น";
			...
			seq_msg_show = seq_msg_show + " <br><span><u>สแกนเสร็จแล้วกดปุ่มถัดไป</u></span>";
		}	
...
//		$("#csh_product_id").numericFilter();
		...
		$('#btnCoupon').button({
	    	...
	    	var status_no=$("#csh_status_no").val();
	    	if(status_no!='00'){
			 	jAlert('คุณทำรายการขายค้างอยู่ กรุณาคลิ๊กปุ่มยกเลิกการขายก่อนเลือกโปรโมชั่นใหม่', 'ข้อความแจ้งเตือน',function(){	            	
	            	return false;
		        });
			 	return false;
			}
	    	...
	    	var onsales=onSales();
		    if(onsales>0){
			 	jAlert('คุณทำรายการขายค้างอยู่ ไม่สามารถเลือกโปรโมชั่นใหม่ขณะทำรายการขายได้', 'ข้อความแจ้งเตือน',function(){	            	
	            	return false;
		        });
			 	return false;
			}
							    	...
							    	$('<div id="dlgChkProCoupon"></div>').dialog({
						  			  ...
						  			  //*WR27102014
						  			    ...
						  			    $.each(arr_keyinput , function(i, val) { 
						  			    	if(arr_keyinput[i]=='I'){
						  			    		j_mc+=1;
						  			    		key_idcad='<tr><td>รหัสบัตรประชาชน :</td><td><input type="text" id="coupon_idcard" size="20" value="' + csh_idcard + '" index="'+j_mc+'" class="input-text-pos keymbinput ui-corner-all">' + 
