		...
		var g = {
					 ...
					 function(i,row) 
					 	{
							...
							//-----------------------*WR25102011* append to
							if(row.absid)
								tr.setAttribute('absid',row.absid);
							//-----------------------*WR25102011* end append
			...
			populate: function () { //get latest data
				...
				var param = [
					...
					,{ name : 'action', value : p.action}/*wr29092010*/
						...
						function ()
							{
									...
									$(tdDiv).css({textAlign:pth.align,width: $('div:first',pth)[0].style.width});
									 //*WR 24112010 change to
									//alert($('div:first',pth)[0].style.width);
									//alert($('div:first',pth).width());
