...
var x;
$(function () {
    console.log('fn : event on promootherlist')
    //38 up 40 down
...
function hotchkkey(new_member, product, quantity) {
    ...
    $.get("/sales/promotion/hotchkkey", {
        ...
        if (data == "Noproduct") {
            ...
            hotpro(product, quantity, new_member);
        }
...
function hotpro(product, quantity, new_member) { //search data for edit
    if (product == "" || quantity == "" || quantity <= 0 || !check_number(quantity)) {
        alert("ป้อนข้อมูลไม่ถูกต้อง");
        $("#csh_product_id").val("");
        $("#csh_quantity").val(1);
    ...
    $.get("/sales/promotion/chkstep", {
        ...
        if (chk = data.substring(0, 12) == "limite_false") {
            ...
            if (arr[1] == "N") {
                ...
                alert("Over the limit of promotion can use " + arr[1] + " ชิ้น");
            }
                ...
                $("#dialog-hotpro").dialog({
                    ...
                    open: function () {
                        ...
                        $(this).parents(".ui-dialog:first").find(".ui-dialog-content").css({
                            "background-color": "#EEF3F8", //#CFE2E5
                            "padding": "0 0 0 0",
                            "margin": "0 0 0 0",
                            "font-size": "27px",
                            "color": "#000"
    ...
    $.get("/sales/promotion/openproauto", {
        ...
        $("#dialog-hotpro").dialog({
            ...
            open: function () {
                ...
                $(this).parents(".ui-dialog:first").find(".ui-dialog-content").css({
                    "background-color": "#EDF0F3", //#CFE2E5
                    "padding": "0 0 0 0",
                    "margin": "0 0 0 0",
                    "font-size": "27px",
                    "color": "#000"
            ...
            buttons: {
                "Play promotion": function () {
                    runproauto();
                    return false;
                },

                "Promotional products": function () {
...
function chkendpro(promo_code) {
    ...
    $.get("/sales/promotion/chkendpro", {
        ...
        // check price less than condition
        if (data == "chkpricelimitpro") {
            $("#manual_input_log").val(data);
            jAlert('Play promotions exceeding the limits set.', 'WARNING!', function () {
                $("#manual_input_product").focus();
                return false;
            });
            return false;
...
function lastgipro(promo_code) { //search data for edit
    ...
    if (promo_code == "OX08030813" || promo_code == "OX08040813" ||
        promo_code == "OX08050813" || promo_code == "OX08020814" ||
        promo_code == "OX08040814" || promo_code == "OX09221214" ||
        promo_code == "OX09171214" || promo_code == "OX09181214" ||
        promo_code == "OX09191214" || promo_code == "OX09201214" ||
        promo_code == "OX09391114" || promo_code == "OX09401114" ||
        promo_code == "OX09411114" || promo_code == "OX09431114" ||
        promo_code == "OX09441114" || promo_code == "OX09451114" ||
        promo_code == "OX08310215" || promo_code == "OX08320215" ||
        promo_code == "OX09200115" || promo_code == "OX09070215" ||
        promo_code == "OX09080215" || promo_code == "OX09090215" ||
        promo_code == "OX09220115" || promo_code == "OX09100215" ||
        promo_code == "OX09110215" || promo_code == "OX09120215" ||
        promo_code == "OT04160315" || promo_code == "OX10020915" ||
        promo_code == "OX08030915" || promo_code == "OX08040915" ||
        promo_code == "OX08030915" || promo_code == "OX08040915" ||
        promo_code == "OX08050915" || promo_code == "OX08211215" ||
        promo_code == "OS07110116" || promo_code == "OX10120116" ||
        promo_code == "OX10050116" || promo_code == "OX10030216" ||
        promo_code == "OX10040216" || promo_code == "OX10050216" ||
        promo_code == "OX10060216" || promo_code == "OX10070216" ||
        promo_code == "OX08041016" || promo_code == "OX08051016" ||
        promo_code == "SS07070218") { //เล่นให้ครบ step
        ...
        $("#dialog-lastpro_play").dialog({
            ...
            beforeClose: function (evt) {
                if (evt.originalEvent && $(evt.originalEvent.which == 27)) {
                    evt.stopPropagation();
                    evt.preventDefault();
                    if ($("#last_promo_seq_hide").val() > '1' && (promo_code == "SS07070218")) {
                        alert("โปรโมชั่นนี้ต้องยิงสินค้าให้ครบค่ะ");
                        return false;
                    }
                }
            ...
            },
            {
                ...
                click: function () {
                    if ((promo_code == "OX08030813" || promo_code == "OX08040813" ||
                        ...
                        promo_code == "OX10060216" || promo_code == "OX10070216" ||
                        promo_code == "OX08041016" || promo_code == "OX08051016" ||
                        promo_code == "SS07070218") && $("#last_promo_seq_hide").val() > '1') {
                        alert("โปรโมชั่นนี้ต้องยิงสินค้าให้ครบค่ะ");
                        return false;
    ...
    $.get("/sales/newmember/registerfrom", {
        ...
        $("#dialog-lastpro_play").dialog({
            ...
            open: function () {
                ...
                $(this).parents(".ui-dialog:first").find(".ui-dialog-content").css({
                    "background-color": "#FFFFFF", //#CFE2E5
                    "padding": "0 0 0 0",
                    "margin": "0 0 0 0",
                    "font-size": "27px",
                    "color": "#f9f9f9"
        ...
        $("#ui-dialog-title-dialog-lastpro_play").html("Form register newmember");
        $("#lastpro_play").html(data);
        $("#id_card").focus();
        //alert($("#application_id").val());
        //return false;
        if ($("#application_id").val() == "OPID300" || $("#application_id").val() == "OPPLI300") {
            document.getElementById('id_card').readOnly = false;
            $("#noid_type").val(5);
    ...
    $.get("/sales/newmember/registerfrom", {
        ...
        $("#dialog-lastpro_play").dialog({
            ...
            buttons: {
                ...
                "cancel": function () {
                    //จะให้ทำไร
                    var cc = confirm("are you sure cancel ?");
                    if (!cc) {
                        return false;
                    }
                    $("#dialog-lastpro_play").dialog("destroy");
...
function chkmobile(xevent) {
    ...
    if (mobile_no != "000") {
        if (!check_number(mobile_no)) {
            ...
            alert("เบอร์มือถือต้องมี 9 หรือ 10 หลัก เท่านั้น");
            $("#mobile_no").focus();
            return false;
        }
    ...
    if (getyear - $("#lyear").val() < 5) {
        alert("อายุของสมาชิกน้อยกว่า 5 ขวบ กรุณาเลือกปีเกิดของสมาชิกใหม่อีกครั้งค่ะ");
        return false;
    }
    if (getyear - $("#lyear").val() > 100) {
        alert("Please input birthday,Age cannot be more than 100");
...
function registersaveafter() {
    ...
    var c = confirm("I need Save OK/CANCEL?");
    if (!c) {
        return false;
    }
    preload();
    $.get("/sales/newmember/registersave", {
        ...
        if (data == "no_add") {
            ...
            alert("Save data no." + $("#doc_no").val() + " completed");
            $("#dialog-lastpro_play").dialog("destroy");
            unpreload()
            //document.location.reload(true);
            //registercardfrom(data);
    ...
    $.get("../../../download_promotion/id_card_quick/read.php", {
        ...
        $("#dialog-lastpro_play").dialog({
            ...
            open: function () {
                ...
                $(this).parents(".ui-dialog:first").find(".ui-dialog-content").css({
                    "background-color": "#8cb1ef", //#CFE2E5
                    "padding": "0 0 0 0",
                    "margin": "0 0 0 0",
                    "font-size": "27px",
                    "color": "#000"
...
function fromreadprofileotp(promo_code, status_otp, member_no, promo_des) {
    $.get("../../../download_promotion/id_card_quick/fromreadprofile_otp.php", {
        ...
        if (promo_code == "BD001") {
            ...
            document.getElementById("nation1").style.visibility = 'hidden';
            document.getElementById("nation2").style.visibility = 'hidden';
            document.getElementById("country_code").style.visibility = 'hidden';
            document.getElementById("show_country").style.display = "none";
            document.getElementById("Nationality").style.visibility = 'hidden';
            document.getElementById("Thai").style.visibility = 'hidden';
            document.getElementById("Foreign").style.visibility = 'hidden';
        }
...
function fromreadprofile_otp_save() {
    ...
    $.get("../../../download_promotion/id_card_quick/fromreadprofile_otp_save.php", {
        ...
        if (arrdata[0] == "MOBILEDIFF") {
            alert("Mobile number entered did not match the database, please contact Beauty Line to change their mobile phone before.");
            return false;
