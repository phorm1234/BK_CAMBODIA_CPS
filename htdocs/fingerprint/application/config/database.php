...
$db['forum']['username'] = "pos-ssup";
$db['forum']['password'] = "P0z-$$up";
$db['forum']['database'] = "ssup";
...
$db['default']['username'] = 'pos-ssup';
$db['default']['password'] = 'P0z-$$up';
$db['default']['database'] = 'ssup';
