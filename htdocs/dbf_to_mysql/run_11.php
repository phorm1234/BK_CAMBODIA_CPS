...
//--------------------------------------------------------------------------
$sql_del="TRUNCATE TABLE pos_ssup.com_mem_pt ";
mysql_query($sql_del,$conn);
//--------------------------------------------------------------------------
$sql_uu="INSERT INTO pos_ssup.com_mem_pt (`doc_no`, `doc_dt`, `flag`, `member`, `point`, `amount`, `net_amt`, `status`) 
SELECT  `DOC_NO`, `DOC_DT`, `FLAG`, `MEMBER`, `POINT`, `AMOUNT`, `NET_AMT`, `STATUS`
FROM  `$tbl`  WHERE  1 ";
...
//--------------------------------------------------------------------------
system("touch /home/shopsetup/dbf_to_mysql/pook11.txt");
?>
