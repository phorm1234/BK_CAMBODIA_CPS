...
if(!file_exists("$db_path")){
		system("touch /home/shopsetup/dbf_to_mysql/pook14.txt");
...
//--------------------------------------------------------------------------
$sql_del="TRUNCATE TABLE pos_ssup.com_expense_list";
mysql_query($sql_del,$conn);

//--------------------------------------------------------------------------
$sql_uu="INSERT INTO pos_ssup.com_expense_list(`corporation_id`, `company_id`, `branch_id`, `branch_no`, `doc_dt`, `edit_dt`, `expense_dt`, `account_code`, `amount`, `remark`) 
SELECT  `BRAND`,`BRAND`,`SHOP`, `SHOP`,`DOC_DT`,   `EDIT_DT`, `EXPN_DT`, `ACC_CODE`, `AMOUNT`, `REMARK` 
FROM  `$tbl`  WHERE  1 ";
