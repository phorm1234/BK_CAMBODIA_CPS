...
function open_product(shelf_no, floor_no, room_no) {
	$.ajax({
		type: "POST", url: "/stock/checkstock/productonshelf", data: { shelf_no: shelf_no, floor_no: floor_no, room_no: room_no }, success:
			function (data) {
...
function search_invoice() {
	...
	$.ajax({
		type: "POST", url: "/stock/stock/getinv", data: {}, success:
			function (data) {
...
function search_doc_to_by_or() {
	...
	$("#dialog_process").dialog("open");
	$.ajax({
		type: "POST", url: "/stock/stock/getdoctobyor", data: {}, success:
			function (data) {
				$("#dialog_process").dialog("close");
				$("#dialog_invoice").html(data);
				$("#dialog_invoice").dialog("open");
...
////////////////// search doc_no to
function search_doc_to_by_to() {
	$("#dialog_process").html("<center><font color='#059562'><img src='/stock/img/ajax-loader.gif' border='0' align='absmiddle'><br><b>Please wait...</b></font></center>");
	$("#dialog_process").dialog("open");
	$.ajax({
		type: "POST", url: "/stock/stock/getdoctobyto", data: {}, success:
			function (data) {
				$("#dialog_process").dialog("close");
				$("#dialog_invoice").html(data);
				$("#dialog_invoice").dialog("open");
...
function keytranfertoor_cancel() {
	jConfirm('Comfirm Cancle?', 'Alert', function (r) {
		if (r == false) {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/cancelkeytranferto", data: {}, success:
					function (data) {
						if (data == "y") {
							$("#invoice").val("");
							$("#invoice").focus();
...
function inputinv(sta) {
	...
	if (check_doc != "INV") {
		$.ajax({
			type: "POST", url: "/stock/stock/checkpl", data: {}, success:
				function (data) {
					if (data > 0) {
						$("#invoice").val(doc_no);
...
function selinv(sta) {
	...
	if (pwd == "") {
		...
		$("#dialog_process").dialog("open");
		$.ajax({
			type: "POST", url: "/stock/stock/checkpassword", data: { doc_no: doc_no, pwd: pwd }, success:
				function (data) {
					if (data == "y") {
						$.ajax({
							type: "POST", url: "/stock/stock/checkproductmaster", data: { doc_no: doc_no }, success:
								function (data) {
									if (data == "y") {
										$("#dialog_process").dialog("close");
										$.ajax({
											type: "POST", url: "/stock/stock/checkinv", data: { doc_no: doc_no }, success:
												function (data) {
													if (data == "n") {
														...
														$.ajax({
															type: "POST", url: "/stock/stock/gentmp", data: { doc_no: doc_no }, success:
																function (data) {
																}
														});
														$("#doc_remark").focus();
...
function selinv_ck(sta) {
	...
	if (pwd == "") {
		...
		$.ajax({
			type: "POST", url: "/stock/stock/checkpasswordck", data: { doc_no: doc_no, pwd: pwd }, success:
				function (data) {
					if (data == "y") {
						$.ajax({
							type: "POST", url: "/stock/stock/gentmpcheckstock", data: { doc_no: doc_no, doc_tp: doc_tp, status_no: status_no }, success:
								function (data) {
									$("#doc_remark").focus();
									viewproducttemp();
								}
...
function viewproducttranfer_b(chk) {
	var doc_no = $("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttranfer", data: { doc_no: '', chk: chk }, success:
			function (data) {
...
function viewproducttranfer_toor(chk) {
	var doc_no = $("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttoor", data: { doc_no: doc_no, chk: chk }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
			}
	});
...
function viewproducttranfer_toto(chk) {
	var doc_no = $("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttoto", data: { doc_no: doc_no, chk: chk }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
			}
	});
...
function viewproductquery() {
	...
	var txt = $("#txt").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getproductquery", data: { flag: flag, txt: txt }, success:
			function (data) {
...
function viewproducttranfer(chk) {
	...
	$("#dialog_process").dialog("open");
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttranfer", data: { doc_no: doc_no, chk: chk, status_no: status_no }, success:
			function (data) {
				if (chk == "s") {
					$.ajax({
						type: "POST", url: "/stock/stock/checkinv", data: { doc_no: doc_no }, success:
...
function viewproducttranfer_stock(chk) {
	var doc_no = $("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttranfer", data: { doc_no: doc_no, chk: chk }, success:
			function (data) {
				if (chk == "s") {
										...
										if (data == "y") {
											jConfirm('Confirm Transfer?', 'Alert', function (r) {
												if (r == false) {
													...
													$("#dialog_process").dialog("open");
													$.ajax({
														type: "POST", url: "/stock/stock/tranin2shopheadtodiary", data: { doc_no: doc_no, doc_remark: doc_remark, doc_tp: doc_tp, status_no: status_no }, dataType: 'json', success:
															function (data) {
																if (data.status == "y") {
																	$("#dialog_process").dialog("close");
																	...
																	jAlert(txt, 'Alert', function () {
																		...
																		cleartxt();*/
																		$.ajax({
																			type: "POST", url: "/stock/stock/printstock", data: { doc_no: data.doc_no }, success:
																				function (data) {
																					cleartxt();
																				}
																		});
					...
					if (data == "y") {
						jConfirm('Confirm Transfer?', 'Alert', function (r) {
							if (r == false) {
								...
								$("#dialog_process").dialog("open");
								$.ajax({
									type: "POST", url: "/stock/stock/tranin2shopheadtodiaryaiao", data: { doc_no: doc_no, doc_remark: doc_remark, doc_tp: doc_tp, status_no: status_no }, dataType: 'json', success:
										function (data) {
											if (data.status == "y") {
												$("#dialog_process").dialog("close");
												var txt = "Doc. No. : " + data.doc_no;
...
function clear_diary(doc_no) {
	$.ajax({
		type: "POST", url: "/stock/stock/cleardiary", data: { doc_no: doc_no }, success:
			function (data) {
...
function keytranfer_cancel(doc_no) {
	...
	jConfirm('Comfirm Cancle?', 'Alert', function (r) {
		if (r == false) {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/cancelkeytranfer", data: { doc_no: doc_no }, success:
					function (data) {
						if (data == "y") {
							$("#invoice").val("");
							$("#invoice").focus();
...
function keytranferrq_cancel() {
	jConfirm('Comfirm Cancle?', 'Alert', function (r) {
		if (r == false) {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/cancelkeytranferrq", data: {}, success:
					function (data) {
						if (data == "y") {
							$("#invoice").val("");
							$("#invoice").focus();
...
function cancel_tranfer_ti() {
	jConfirm('Comfirm Cancle?', 'Alert', function (r) {
		if (r == false) {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/canceltranferti", data: {}, success:
					function (data) {
						if (data == "y") {
							$("#invoice").val("");
							$("#invoice").focus();
...
function check_docno() {
	...
	if (doc_no == "") {
		...
		$.ajax({
			type: "POST", url: "/stock/stock/checkdiary1docno", data: { doc_no: doc_no }, success:
				function (data) {
					if (data == "y") {
						var txt = "Product ID : " + doc_no + " repeat data transfer, please check.";
						jAlert(txt, 'Alert', function () {
						...
						$.ajax({
							type: "POST", url: "/stock/stock/checkheaddocno", data: { doc_no: doc_no }, success:
								function (data) {
									if (data == "y") {
...
function check_product() {
	...
	var qty = $("#qty").val();
	/*if(invoice==""){
		var txt="กรุณาป้อนProduct IDโอนเข้า";
		jAlert(txt, 'Alert', function() {
			$("#invoice").focus();
		});
	}else{*/
	if (product_id == "") {
		...
		if (status_no == "30") {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/" + page, data: { product_id: product_id, status_no: status_no, qty: qty }, success:
					function (data) {
						if (data == "n") {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/" + page, data: { product_id: product_id, status_no: status_no }, success:
					function (data) {
						if (data == "n") {
							var txt = "Not found Product ID : : " + product_id;
							jAlert(txt, 'Alert', function () {
...
function get_check_qty() {
	...
	if (product_id == "") {
		...
		if (qty == "") {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/checkproductinvoiceqty", data: { inv: inv, product_id: product_id, qty: qty, doc_status: doc_status }, success:
					function (data) {
						if (data == "1") {
...
function get_check_qty_rq() {
	...
	if (inv == "") {
		...
		$.ajax({
			type: "POST", url: "/stock/stock/checkinvoicerq", data: { inv: inv, doc_status: doc_status }, success:
				function (data) {
					if (data == "y") {
						if (product_id == "") {
							var txt = "Please insert Product ID";
							...
							$.ajax({
								type: "POST", url: "/stock/stock/checkproductinvoicerq", data: { inv: inv, product_id: product_id, doc_status: doc_status }, success:
									function (data) {
										if (data == "y") {
											if (qty == "") {
												var txt = "Please insert the quantity";
												...
												$.ajax({
													type: "POST", url: "/stock/stock/checkproductinvoiceqtyrq", data: { inv: inv, product_id: product_id, qty: qty, doc_status: doc_status }, success:
														function (data) {
															if (data == "1") {
																var txt = "Quantity exceeded, please check";
																jAlert(txt, 'Alert', function () {
...
function get_check_qty_testter_fix() {
	...
	if (product_id == "") {
		...
		if (qty == "") {
			...
			if (qty > 0) {
				$.ajax({
					type: "POST", url: "/stock/stock/checkproducttestterfix", data: { product_id: product_id, status_no: status_no, qty: qty }, success:
						function (data) {
							if (data == "n") {
								var txt = "Not found Product ID : : " + product_id;
								jAlert(txt, 'Alert', function () {
...
function get_check_qty_tester() {
	...
	if (product_id == "") {
		...
		if (qty == "") {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/checkproduct", data: { product_id: product_id, status_no: status_no }, success:
					function (data) {
						if (data == "n") {
							var txt = "Not found Product ID : : " + product_id;
							jAlert(txt, 'Alert', function () {
							...
							$.ajax({
								type: "POST", url: "/stock/stock/" + page, data: { product_id: product_id, status_no: status_no, qty: qty }, dataType: 'json', success:
									function (data) {
										if (data.status == "1") {
	...
	if (qty <= "0") {
		...
		if (product_id == "") {
			...
			if (qty == "") {
				...
				$.ajax({
					type: "POST", url: "/stock/stock/checkpasswordck", data: { doc_no: invoice, pwd: pwd }, success:
						function (data) {
							if (data == "y") {
								$.ajax({
									type: "POST", url: "/stock/stock/checkproduct", data: { product_id: product_id, status_no: status_no }, success:
...
function create_tmpdiary() {
	...
	$.ajax({
		type: "POST", url: "/stock/stock/inserttmpdiary?type_tranfer=" + type_tranfer + "&type_product=" + type_product, data: form, success:
			function (data) {
				if (data == "y") {
					//$("#doc_status").attr('disabled', true);
					//$("#doc_status").removeAttr('disabled');
...
function create_tmpdiary_to() {
	...
	// 	} else {
	// 		$.ajax({
	// 			type: "POST", url: "/stock/stock/tranin2shopheadtodiaryto", data: { doc_no: doc_no, doc_remark: doc_remark, doc_tp: doc_tp, status_no: status_no, inv: inv }, dataType: 'json', success:
	// 				function (data) {
	// 					if (data.status == "y") {
	// 						var txt = "Doc. No. : " + data.doc_no;
	// 						jAlert(txt, 'Alert', function () {
	// 							$.ajax({
	// 								type: "POST", url: "/stock/stock/printtranto", data: { doc_no: data.doc_no }, success:
	// 									function (data) {
	// 										checktempdiary_to();
	// 										cleartxt();
	// 									}
	...
	if (status_no == "25") {
		if (qty > 2) {
			...
			var form = $('form#frm_tranferkeyin').serialize();
			$.ajax({
				type: "POST", url: "/stock/stock/inserttmpdiaryto?type_tranfer=" + type_tranfer + "&type_product=" + type_product, data: form, success:
					function (data) {
						if (data == "y") {
...
function create_tmpdiary_rq() {
	...
	var form = $('form#frm_tranferkeyin').serialize();
	$.ajax({
		type: "POST", url: "/stock/stock/inserttmpdiaryrq?type_tranfer=" + type_tranfer + "&type_product=" + type_product, data: form, success:
			function (data) {
				if (data == "y") {
					checktempdiary_rq();
...
function viewproductkeytranfer(chk) {
	var doc_no = $("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getkeyproducttranfer", data: { doc_no: doc_no, chk: chk }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
				$("#product_id").val("");
				$("#qty").val("");
...
function viewproductkeytranfer_to(chk) {
	var doc_no = $("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getkeyproducttranferto", data: { chk: chk, doc_no: doc_no }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
				$("#product_id").val("");
				$("#qty").val("");
...
function viewproductkeytranfer_to_b(chk) {
	//var doc_no=$("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getkeyproducttranferto", data: { chk: chk }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
			}
	});
...
function viewproductkeytranfer_to_or(chk) {
	//var doc_no=$("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttoor", data: { chk: chk }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
			}
	});
...
function viewproductkeytranfer_to_to(chk) {
	//var doc_no=$("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttoto", data: { chk: chk }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
			}
	});
...
function viewproductkeytranfer_rq(chk) {
	//var doc_no=$("#invoice").val();
	$.ajax({
		type: "POST", url: "/stock/stock/getkeyproducttranferrq", data: { chk: chk }, success:
			function (data) {
				$("#viewproducttranfer").html(data);
				$("#product_id").val("");
				$("#qty").val("");
...
function viewproducttemp() {
	var form = $('form#frm_tranferkeyin').serialize();
	$.ajax({
		type: "POST", url: "/stock/stock/getproducttemp", data: form, success:
			function (data) {
...
function keytranfer_tranin2shopheadtodiary_to() {
	console.log('fn: keytranfer_tranin2shopheadtodiary_to')
	var doc_no = $("#invoice").val();
	var doc_remark = $("#doc_remark").val();
	var doc_tp = $("#doc_tp").val();
	var status_no = $("#status_no").val();
...
function keytranfer_tranin2shopheadtodiary_to_bykeyin() {
	console.log('fn: keytranfer_tranin2shopheadtodiary_to_bykeyin')
	var doc_no = $("#invoice").val();
	var doc_remark = $("#doc_remark").val();
	var doc_tp = $("#doc_tp").val();
	var status_no = $("#status_no").val();
	...
	jConfirm('Confirm Transfer?', 'Alert', function (r) {
		if (r == false) {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/tranin2shopheadtodiarytobykeyin", data: { doc_no: doc_no, doc_remark: doc_remark, doc_tp: doc_tp, status_no: status_no, inv: inv }, dataType: 'json', success:
					function (data) {
						if (data.status == "y") {
							var txt = "Doc. No. : " + data.doc_no;
							jAlert(txt, 'Alert', function () {
...
function keytranfer_tranin2shopheadtodiary_rq() {
	...
	jConfirm('Confirm Transfer?', 'Alert', function (r) {
		if (r == false) {
			...
			$.ajax({
				type: "POST", url: "/stock/stock/tranin2shopheadtodiaryrq", data: { doc_no: doc_no, doc_remark: doc_remark, doc_tp: doc_tp, status_no: status_no, inv: inv }, dataType: 'json', success:
					function (data) {
						if (data.status == "y") {
							var txt = "Doc. No. : " + data.doc_no;
							jAlert(txt, 'Alert', function () {
								...
								$.ajax({
									type: "POST", url: "/stock/stock/printrq", data: { doc_no: data.doc_no }, success:
										function (data) {
											checktempdiary_rq();
											cleartxt();
										}
...
function search_docno_ai(p_type) {
	$.ajax({
		type: "POST", url: "/stock/stock/getdocnochkstock", data: { p_type: p_type }, success:
			function (data) {
				$("#dialog_invoice").html(data);
				$("#dialog_invoice").dialog("open");
			}
...
function search_bill_vt(doc_tp) {
	$.ajax({
		type: "POST", url: "/stock/miscellaneous/getdocnobill", data: { doc_tp: doc_tp }, success:
			function (data) {
...
function search_docno_to() {
	$.ajax({
		type: "POST", url: "/stock/stock/checktempdiaryto", data: {}, success:
			function (data) {
				if (data == "y") {
					...
					var tbl = "trn_diary1";
					$.ajax({
						type: "POST", url: "/stock/stock/getdocnoto", data: { status_no: status_no, tbl: tbl }, success:
							function (data) {
...
function search_docno_rq() {
	$.ajax({
		type: "POST", url: "/stock/stock/checktempdiaryrq", data: {}, success:
			function (data) {
				if (data == "y") {
...
function getbillvtdetail(doc_no) {
	$.ajax({
		type: "POST", url: "/stock/miscellaneous/getbillvtdetail", data: { doc_no: doc_no }, dataType: 'json', success:
			function (data) {
...
function eidt_contace_bill_vt() {
	...
	if (doc_tpye == "") {
		...
		if (doc_no == "") {
			...
			$.ajax({
				type: "POST", url: "/stock/miscellaneous/editcontactbillvt", data: form, success:
					function (data) {
						if (data == "y") {
...
function editconfigprinter() {
	...
	$.ajax({
		type: "POST", url: "/stock/miscellaneous/editconfigprinter", data: { code_type: code_type, default_status: default_status }, success:
			function (data) {
				if (data == "y") {
					jAlert('Save success', 'Alert', function () {
...
function search_gp() {
	$.ajax({
		type: "POST", url: "/stock/miscellaneous/getsearchgp", data: {}, success:
			function (data) {
				$("#dialog_gp").html(data);
	...
	if (barcode == "") {
		...
		jConfirm('Confirm Save?', 'Alert', function (r) {
			if (r == false) {
				...
				$.ajax({
					type: "POST", url: "/stock/miscellaneous/saveformgp", data: form, success:
						function (data) {
							if (data == "y") {
...
function product_id_master(product_id) {
	...
	if (product_id == "") {
		...
		$.ajax({
			type: "POST", url: "/stock/stock/checkproductid", async: false, data: { product_id: product_id }, success:
				function (data) {
					if (data == "y") {
						rs = "y";
					} else {
...
function add_tmpdiary(doc_tp, status_no) {
	...
	$.ajax({
		type: "POST", url: "/stock/stock/addtmpdiary?doc_tp=" + doc_tp + "&status_no=" + status_no, data: form, success:
			function (data) {
				if (data == "y") {
					form_data();
					focus_keytranfer();
