...
foreach($shelf_no as $val_shelf){
	...
	$pdf->Ln();
	$pdf->Cell(170,$hline,"เอกสาร การตรวจนับสินค้า",0,0,'L',0);
	...
	$pdf->Cell(25,$head_col,"ตรวจนับ 1",0,0,'C',0);
	$pdf->Cell(25,$head_col,"ตรวจนับ 2",0,0,'C',0);
	$pdf->Cell(25,$head_col,"ตรวจนับ 3",0,0,'C',0);
	$pdf->Ln();
