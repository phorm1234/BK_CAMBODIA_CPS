...
foreach($shelf_no as $val_shelf){
	...
	$pdf->Ln();
	$pdf->Cell(170,$hline,"เอกสาร การตรวจนับ",0,0,'L',0);
	$pdf->Cell(30,$hline,"หน้าที่",0,0,'L',0);
	$pdf->Ln();
	$pdf->Cell(50,$hline,"วันที่ตรวจนับ : $date",0,0,'L',0);
	$pdf->Cell(90,$hline,"เลขที่เอกสาร : $doc_no",0,0,'L',0);
	...
	$head_col=5;
	$pdf->SetFont('Cordia','B',12);
	$pdf->Cell(28,$head_col,"รหัสชั้นวาง",0,0,'C',0);
	$pdf->Cell(28,$head_col,"หรัสห้อง",0,0,'C',0);
	$pdf->Cell(28,$head_col,"รหัสสินค้า",0,0,'C',0);
	$pdf->Cell(20,$head_col,"สถานะ",0,0,'C',0);
	$pdf->Cell(20,$head_col,"ตรวจนับ 1",0,0,'C',0);
	$pdf->Cell(20,$head_col,"ตรวจนับ 2",0,0,'C',0);
	$pdf->Cell(20,$head_col,"ตรวจนับ 3",0,0,'C',0);
	$pdf->Cell(20,$head_col,"สินค้าคงเหลือ",0,0,'C',0);
	$pdf->Ln();
	...
	$pdf->SetFont('Cordia','',12);
	$pdf->Cell(18,$head_col_line,"ผู้ตรวจนับ",0,0,'L',0);
	...
	$pdf->Cell(18,$head_col_line,"ผู้ตรวจข้อมูล",0,0,'L',0);
	$pdf->Cell(1,$head_col_line,":",0,0,'C',0);
	$pdf->Cell(40,$head_col_line,"________________________",0,0,'L',0);
	$pdf->Cell(7,$head_col_line,"วันที่",0,0,'L',0);
	$pdf->Cell(20,$head_col_line,"__/__/______",0,0,'L',0);
	...
	$pdf->Cell(18,$head_col_line,"ผู้ป้อนข้อมูล",0,0,'L',0);
	$pdf->Cell(1,$head_col_line,":",0,0,'C',0);
	$pdf->Cell(40,$head_col_line,"________________________",0,0,'L',0);
	$pdf->Cell(7,$head_col_line,"วันที่",0,0,'L',0);
	$pdf->Cell(20,$head_col_line,"__/__/______",0,0,'L',0);
