...
function SetThaiFont()
{
	...
	$this->AddFont('CordiaNew','','browa.php');
	$this->AddFont('CordiaNew','B','browab.php');
	$this->AddFont('CordiaNew','I','browai.php');
	$this->AddFont('CordiaNew','IB','browaz.php');

	$this->AddFont('IrisUPC','','browa.php');
	$this->AddFont('IrisUPC','B','browab.php');
	$this->AddFont('IrisUPC','I','browai.php');
	$this->AddFont('IrisUPC','IB','browaz.php');
...
function FPDF($orientation='P',$unit='mm',$format='a4')
{
	...
	if(is_string($format))
	{
		...
		//pook
		elseif($format=='a8')
			$format=array(76.2,101.6);
		elseif($format=='a43')
 			$format=array(216.0,288.0);
		elseif($format=='a4')
			$format=array(595.28,841.89);
		elseif($format=='a5')
