 ...
 (function($) {
	 ...
	 var methods = {
		...
		*/
			...
			for (var i = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "creditCard":
						...
						break;
					case "idCard" :
						errorMsg = methods._valididcardField(field, rules, i, options);
						break;
					default:
		...
		/**
		 * Validates Identify Card
		 */
		_valididcardField:function(field, rules, i, options){
			var id = field.val();			
		    for(var i=0, sum=0; i < 12; i++)
		        sum += parseFloat(id.charAt(i))*(13-i);
		    if((11-sum%11)%10!=parseFloat(id.charAt(12))) 
		    	return options.allrules.idCard.alertText
